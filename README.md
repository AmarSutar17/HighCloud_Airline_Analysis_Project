...
🧠 DAX (Data Analysis Expressions) – Used for calculated measures, KPIs, and dynamic metrics

🗂 Data Modeling – Relationships built across fact and dimension tables for accurate filtering

📁 File Format – .pbix for development and .png for dashboard preview

4️⃣ Data Source

Source: Simulated airline operational dataset (HighCloud Airlines)
...
Airline companies handle large volumes of operational and customer data, but decision-makers often lack a unified, visual way to analyze performance across multiple dimensions such as routes, aircraft, revenue, and passenger traffic.
...
The HighCloud Airlines Analytics Dashboard demonstrates strong analytical thinking, data modeling skills, and effective use of Power BI to solve real-world business problems in the aviation industry.
